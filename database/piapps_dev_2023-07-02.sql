...
#
# Host: 127.0.0.1 (MySQL 5.5.5-10.5.20-MariaDB-1:10.5.20+maria~ubu2004-log)
# Database: piapps_dev
# Generation Time: 2023-07-02 02:05:02 +0000
# ************************************************************
...
VALUES
	('I00001','S00001','es kristal tube','bar','bar cost','Bal',89.0,0.0,20000,26,'2023-03-31 09:26:44',26,'2023-07-02 00:37:33'),
	('I00002','S00058','DRIPP - Yuzu pulp','bar','bar cost','Btl',62.0,0.0,166500,26,'2023-03-31 09:28:32',26,'2023-07-02 00:47:21'),
	('I00003','S00044','kacang mede','kitchen','food cost','Klg',84.0,0.0,160000,26,'2023-03-31 09:29:58',26,'2023-07-02 00:37:33'),
	('I00004','S00002','Telur','Test','Test','Kg',90.0,0.0,15000,26,'2023-05-11 03:06:32',26,'2023-07-02 00:37:33');
...
VALUES
	(1,'RQ-2023-0000001','','2023-07-02','I00001','es kristal tube','Bal',11.0,'Kitchen',26,'2023-07-02 00:37:16','1',26,'2023-07-02 07:37:33'),
	(2,'RQ-2023-0000001','','2023-07-02','I00003','kacang mede','Klg',5.0,'Kitchen',26,'2023-07-02 00:37:21','1',26,'2023-07-02 07:37:33'),
	(3,'RQ-2023-0000001','','2023-07-02','I00004','Telur','Kg',15.0,'Kitchen',26,'2023-07-02 00:37:31','1',26,'2023-07-02 07:37:33'),
	(4,'RQ-2023-0000002','','2023-07-02','I00002','DRIPP - Yuzu pulp','Btl',13.0,'Bar',26,'2023-07-02 00:44:02','1',26,'2023-07-02 07:47:21');
...
CREATE TABLE `is_part_trans` (
  ...
  `kode_suplier` varchar(20) NOT NULL DEFAULT '',
  `created_user` int(3) NOT NULL,
  `created_date` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `bukti` varchar(80) NOT NULL,
  `group` enum('Kitchen','Bar','Pastry') DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `is_part_trans` (`id`, `tanggal_transaksi`, `kode_transaksi`, `referensi`, `kode_request`, `no_sj`, `keterangan`, `kode_part`, `satuan`, `nama`, `resto`, `qty`, `harga`, `kode_suplier`, `created_user`, `created_date`, `bukti`, `group`)
VALUES
	(1,'2023-07-02','RQ-2023-0000001','ISSUE','','','','I00001','Bal','es kristal tube','',-11,0,'',26,'2023-07-02 00:37:16','','Kitchen'),
	(2,'2023-07-02','RQ-2023-0000001','ISSUE','','','','I00003','Klg','kacang mede','',-5,0,'',26,'2023-07-02 00:37:21','','Kitchen'),
	(3,'2023-07-02','RQ-2023-0000001','ISSUE','','','','I00004','Kg','Telur','',-15,0,'',26,'2023-07-02 00:37:31','','Kitchen'),
	(4,'2023-07-02','RQ-2023-0000002','ISSUE','','','','I00002','Btl','DRIPP - Yuzu pulp','',-13,0,'',26,'2023-07-02 00:44:02','','Bar'),
	(5,'2023-06-07','S00001','SALES','','','','I00003','Klg','kacang mede','',-2,160000,'',26,'2023-07-02 01:35:30','','Kitchen'),
	(6,'2023-06-07','S00001','SALES','','','','I00004','Kg','Telur','',-4,15000,'',26,'2023-07-02 01:35:30','','Kitchen'),
	(7,'2023-06-08','S00002','SALES','','','','I00002','Btl','DRIPP - Yuzu pulp','',-6,166500,'',26,'2023-07-02 01:35:30','','Bar');
...
CREATE TABLE `is_produk` (
  `kode_produk` varchar(14) NOT NULL,
...
INSERT INTO `is_produk` (`kode_produk`, `nama_produk`, `group`, `created_user`, `created_date`, `updated_user`, `updated_date`)
VALUES
	('P-2023-0000001','Nasi Goreng','Kitchen',26,'2023-07-02 01:34:15',1,'2023-07-02 01:34:15'),
	('P-2023-0000002','Ice Suka Suka','Bar',26,'2023-07-02 01:34:52',1,'2023-07-02 01:34:52');
...
VALUES
	(1,'P-2023-0000001','I00003',2.00),
	(2,'P-2023-0000001','I00004',4.00),
	(4,'P-2023-0000002','I00002',6.00);
...
LOCK TABLES `is_sales` WRITE;
/*!40000 ALTER TABLE `is_sales` DISABLE KEYS */;

INSERT INTO `is_sales` (`no`, `resto`, `tanggal`, `value`, `bill_total`, `customer`, `disc`, `sub_total`, `service_charge_total`, `total_sale`, `tax_total`, `vat_total`, `delivery_cost`, `rounding`, `net_sales`, `grand_total`, `total_payment`, `diff_payment`, `cash`, `credit_card`, `debit_card`, `member_deposit`, `product_code`, `qty`)
VALUES
	('S00001','LIBERO COFFEE AND GELATO','2023-06-07',46200.00,1.00,1.00,0.00,40000.00,2000.00,42000.00,4200.00,0.00,0.00,0.00,40000.00,46200.00,46200.00,0.00,0.00,0.00,46200.00,0.00,'P-2023-0000001',2),
	('S00002','LIBERO COFFEE AND GELATO','2023-06-08',259875.00,1.00,1.00,0.00,225000.00,11250.00,236250.00,23625.00,0.00,0.00,-25.00,225000.00,259875.00,259900.00,25.00,0.00,0.00,259900.00,0.00,'P-2023-0000002',5);

/*!40000 ALTER TABLE `is_sales` ENABLE KEYS */;
UNLOCK TABLES;
