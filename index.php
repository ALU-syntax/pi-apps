...
<html>
  <head>
    ...
    <meta name="description" content="Aplikasi Pembelian">
  ...
  <body class="login-page bg-login">
    <div class="login-box">
      <div style="color:#3c8dbc" class="login-logo">
        <img style="margin-top:-12px" src="assets/img/logo-blue.png" alt="Logo" height="50"> <b>Pembelian</b>
      </div><!-- /.login-logo -->
      <?php  
    ...
    <!-- jQuery 2.1.3
    <script src="assets/plugins/jQuery/jQuery-2.1.3.min.js"/>
	-->
