...
--
-- Host: localhost:3306
-- Generation Time: Jun 24, 2023 at 12:24 AM
...
--
-- Database: `yoom8124_piapps`
--

-- --------------------------------------------------------

--
-- Table structure for table `is_invoice`
--
...
--
-- Dumping data for table `is_invoice`
--

INSERT INTO `is_invoice` (`id`, `tanggal`, `kode_suplier`, `suplier`, `nomor`, `referensi`, `tipe`, `amount`, `lunas`, `keterangan`, `lampiran`, `resto`, `createdby`, `createdon`, `bukti`, `input_by`) VALUES
(136, '2023-05-11', 'S00015', 'Fresh Store', 'TR-2023-0000001', '', 'Purch', 150000, b'1', '', '', '', 26, '2023-05-11 11:30:47', '', 'Purchasing');

-- --------------------------------------------------------

--
-- Table structure for table `is_part`
--
...
--
-- Dumping data for table `is_part`
--

INSERT INTO `is_part` (`kode_part`, `kode_suplier`, `nama_part`, `group`, `kategori`, `satuan`, `stok`, `stok_level`, `harga`, `created_user`, `created_date`, `updated_user`, `updated_date`) VALUES
...
--
-- Table structure for table `is_part_consump`
--
...
--
-- Dumping data for table `is_part_consump`
--

INSERT INTO `is_part_consump` (`id`, `kode_request`, `keterangan`, `tanggal`, `kode_item`, `nama_item`, `satuan`, `qty`, `group`, `created_user`, `created_date`, `is_approved`, `approved_user`, `approved_date`) VALUES
...
--
-- Table structure for table `is_part_req`
--
...
--
-- Dumping data for table `is_part_req`
--

INSERT INTO `is_part_req` (`id`, `kode_request`, `keterangan`, `tanggal`, `jatuh_tempo`, `kode_part`, `nama_item`, `satuan`, `qty`, `harga`, `diskon`, `pajak`, `jumlah`, `kode_suplier`, `suplier`, `remain_receipt`, `status`, `tipe`, `created_user`, `created_date`, `approved_user`, `approved_date`, `bukti`, `status_bayar`) VALUES
(2561, 'PO-20230318003', 'Test', '2023-03-18', '2023-03-25', 'I00441', 'wortel', 'Kg', 1.00, 20000.00, 0.00, 0.00, 20000.00, 'S00015', 'Fresh Store', 1, 1, 'CASH', 26, '2023-05-11 04:30:08', NULL, NULL, '', 'Unpaid'),
(2562, 'PO-20230318003', 'Test', '2023-03-18', '2023-03-25', 'I00442', 'cabe merah', 'Kg', 1.00, 70000.00, 0.00, 0.00, 70000.00, 'S00015', 'Fresh Store', 1, 1, 'CASH', 26, '2023-05-11 04:30:08', NULL, NULL, '', 'Unpaid'),
(2563, 'PO-20230318003', 'Test', '2023-03-18', '2023-03-25', 'I00004', 'Telur', 'Kg', 10.00, 15000.00, 20000.00, 0.00, 130000.00, 'S00002', 'Agus Telur', 0, 2, 'CASH', 26, '2023-05-11 04:30:08', NULL, NULL, '', 'Unpaid');

-- --------------------------------------------------------

--
-- Table structure for table `is_part_trans`
--
...
--
-- Dumping data for table `is_part_trans`
--

INSERT INTO `is_part_trans` (`id`, `tanggal_transaksi`, `kode_transaksi`, `referensi`, `kode_request`, `no_sj`, `keterangan`, `kode_part`, `satuan`, `nama`, `resto`, `qty`, `harga`, `kode_suplier`, `created_user`, `created_date`, `bukti`) VALUES
...
--
-- Table structure for table `is_sales`
--
...
--
-- Table structure for table `is_salesss`
--
...
--
-- Dumping data for table `is_salesss`
--

INSERT INTO `is_salesss` (`no`, `resto`, `tanggal`, `value`) VALUES
('S00001', 'Libero', '2022-08-09', 22333);

-- --------------------------------------------------------

--
-- Table structure for table `is_suplier`
--
...
--
-- Dumping data for table `is_suplier`
--

INSERT INTO `is_suplier` (`kode`, `nama`, `alamat`, `group`, `telepon`, `email`, `no_rekening`, `pic`, `top`, `createdBy`, `updatedBy`, `createdOn`, `updatedOn`) VALUES
...
--
-- Table structure for table `is_temp_in`
--
...
--
-- Dumping data for table `is_temp_in`
--

INSERT INTO `is_temp_in` (`id`, `part_req_id`, `tanggal_transaksi`, `kode_part`, `nama`, `tipe`, `qty`, `satuan`, `harga`, `kode_suplier`, `created_user`, `created_date`) VALUES
...
--
-- Table structure for table `is_temp_inv`
--
...
--
-- Dumping data for table `is_temp_inv`
--

INSERT INTO `is_temp_inv` (`id`, `tanggal`, `nomor`, `resto`, `tipe`, `amount`, `keterangan`, `createdby`, `createdon`) VALUES
(25, '2023-05-02', 'INV-20230502001', '3', 'Energi', 3, '33', 1, '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `is_temp_out`
--
...
--
-- Table structure for table `is_temp_req`
--
...
INSERT INTO `is_users` (`id_user`, `resto`, `username`, `nama_user`, `password`, `email`, `telepon`, `foto`, `hak_akses`, `hari_reminder`, `status`, `created_at`, `updated_at`) VALUES
...
--
-- Indexes for table `is_invoice`
--
ALTER TABLE `is_invoice`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `is_part`
--
ALTER TABLE `is_part`
...
--
-- Indexes for table `is_part_consump`
--
ALTER TABLE `is_part_consump`
  ADD PRIMARY KEY (`id`) USING BTREE,
  ADD KEY `FK_is_part_req_is_users` (`created_user`) USING BTREE,
  ADD KEY `Kode_request` (`kode_request`) USING BTREE,
  ADD KEY `FK_is_part_req_is_part` (`kode_item`) USING BTREE;

--
-- Indexes for table `is_part_req`
--
ALTER TABLE `is_part_req`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_is_part_req_is_users` (`created_user`),
  ADD KEY `FK_is_part_req_is_part` (`kode_part`) USING BTREE,
  ADD KEY `Kode_request` (`kode_request`) USING BTREE;

--
-- Indexes for table `is_part_trans`
--
ALTER TABLE `is_part_trans`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_barang` (`kode_part`),
  ADD KEY `created_user` (`created_user`);

--
-- Indexes for table `is_suplier`
--
ALTER TABLE `is_suplier`
  ADD PRIMARY KEY (`kode`);

--
-- Indexes for table `is_temp_in`
--
ALTER TABLE `is_temp_in`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_barang` (`kode_part`),
  ADD KEY `created_user` (`created_user`);

--
-- Indexes for table `is_temp_inv`
--
ALTER TABLE `is_temp_inv`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `is_temp_out`
--
ALTER TABLE `is_temp_out`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_barang` (`kode_part`),
  ADD KEY `created_user` (`created_user`);

--
-- Indexes for table `is_temp_req`
--
ALTER TABLE `is_temp_req`
  ADD PRIMARY KEY (`id`) USING BTREE;
...
--
-- AUTO_INCREMENT for table `is_invoice`
--
ALTER TABLE `is_invoice`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=137;

--
-- AUTO_INCREMENT for table `is_part_consump`
--
ALTER TABLE `is_part_consump`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2412;

--
-- AUTO_INCREMENT for table `is_part_req`
--
ALTER TABLE `is_part_req`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2564;

--
-- AUTO_INCREMENT for table `is_part_trans`
--
ALTER TABLE `is_part_trans`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5081;

--
-- AUTO_INCREMENT for table `is_temp_in`
--
ALTER TABLE `is_temp_in`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2689;

--
-- AUTO_INCREMENT for table `is_temp_inv`
--
ALTER TABLE `is_temp_inv`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `is_temp_out`
--
ALTER TABLE `is_temp_out`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11401;

--
-- AUTO_INCREMENT for table `is_temp_req`
--
ALTER TABLE `is_temp_req`
...
--
ALTER TABLE `is_users`
  MODIFY `id_user` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
-- Constraints for table `is_part`
--
ALTER TABLE `is_part`
  ADD CONSTRAINT `is_part_ibfk_1` FOREIGN KEY (`created_user`) REFERENCES `is_users` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `is_part_ibfk_2` FOREIGN KEY (`updated_user`) REFERENCES `is_users` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `is_part_consump`
--
ALTER TABLE `is_part_consump`
  ADD CONSTRAINT `is_part_consump_ibfk_1` FOREIGN KEY (`created_user`) REFERENCES `is_users` (`id_user`);

--
-- Constraints for table `is_part_req`
--
ALTER TABLE `is_part_req`
  ADD CONSTRAINT `FK_is_part_req_is_users` FOREIGN KEY (`created_user`) REFERENCES `is_users` (`id_user`);

--
-- Constraints for table `is_part_trans`
--
ALTER TABLE `is_part_trans`
  ADD CONSTRAINT `is_part_Trans_ibfk_2` FOREIGN KEY (`created_user`) REFERENCES `is_users` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `is_temp_in`
--
ALTER TABLE `is_temp_in`
  ADD CONSTRAINT `is_temp_in_ibfk_2` FOREIGN KEY (`created_user`) REFERENCES `is_users` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `is_temp_out`
--
ALTER TABLE `is_temp_out`
  ADD CONSTRAINT `is_temp_out_ibfk_2` FOREIGN KEY (`created_user`) REFERENCES `is_users` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
