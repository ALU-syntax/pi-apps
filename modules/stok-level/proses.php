...
// jika user sudah login, maka jalankan perintah untuk insert, update, dan delete
    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['simpan'])) {
            ...
            $query = mysqli_query($mysqli, "INSERT INTO is_part(kode_part, nama_part, `group`, kategori , satuan, created_user, updated_user) 
                                            VALUES('$kode_part','$nama_part','$group','$kategori','$satuan','$created_user','$created_user')")
    ...
    elseif ($_GET['act']=='delete') {
        if (isset($_GET['id'])) {
            ...
            if ($query) {
                ...
                header("location: ../../main.php?module=part&alert=3");
            }
        }
    }       
}       
