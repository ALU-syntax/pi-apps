...
//else {
	...
	if ($_GET['act']=='insert') {
		...
		if (isset($_POST['simpan'])) {
            ...
            // cek query
            if ($query) {
                echo '<script type="text/javascript">location.href="../../main.php?module=user&alert=1"</script>';
				...
				if (empty($_POST['password']) && empty($_FILES['foto']['name'])) {
                    ...
                    if ($query) {
                        ...
                        //header("location: ../../main.php?module=user&alert=2");
                         ...
                         echo '<script type="text/javascript">location.href="../../main.php?module=user&alert=2"</script>';
                    }
				}
					...
					if (in_array($extension, $allowed_extensions)) {
	                    ...
	                    if($ukuran_file <= 1000000) { // Cek apakah ukuran file yang diupload kurang dari sama dengan 1MB
	                        ...
	                        if(move_uploaded_file($tmp_file, $path_file)) { // Cek apakah gambar berhasil diupload atau tidak
	                            ...
	                            echo '<script type="text/javascript">location.href="../../main.php?module=user&alert=5"</script>';
	                        }
	                    } else {
	                        // Jika ukuran file lebih dari 1MB, tampilkan pesan gagal upload
	                        //header("location: ../../main.php?module=user&alert=6");
	                        echo '<script type="text/javascript">location.href="../../main.php?module=user&alert=6"</script>';
	                    }
	                } else {
	                    // Jika tipe file yang diupload bukan jpg, jpeg, png, tampilkan pesan gagal upload
	                    //header("location: ../../main.php?module=user&alert=7");
	                    echo '<script type="text/javascript">location.href="../../main.php?module=user&alert=7"</script>';
	                } 
				}
	...
	elseif ($_GET['act']=='on') {
		if (isset($_GET['id'])) {
            ...
            if ($query) {
                ...
                echo '<script type="text/javascript">location.href="../../main.php?module=user&alert=3"</script>';
            }
		}
	}
	...
	elseif ($_GET['act']=='off') {
		if (isset($_GET['id'])) {
            ...
            if ($query) {
                ...
                echo '<script type="text/javascript">location.href="../../main.php?module=user&alert=4"</script>';
            }
		}
	}		
//}		
