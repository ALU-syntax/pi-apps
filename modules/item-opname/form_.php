...
if ($_GET['form'] == 'add') { ?>
	...
	<section class="content-header">
		<h1>
			<i class="fa fa-edit icon-title"></i> Input Stok Opname
		</h1>
		<ol class="breadcrumb">
			<li><a href="?module=beranda"><i class="fa fa-home"></i> Beranda </a></li>
			<li><a href="?module=item_opname"> Stok Opname </a></li>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="box box-primary">
					<!-- form start -->
					<form role="form" class="form-horizontal" action="modules/item-opname/proses.php" method="POST"
						name="formItemOpname" id="formItemOpname">
						<!--action="modules/produk/proses.php?act=insert" method="POST" -->
						<input type="hidden" name="act" value="insert" />
						<div class="box-body">
							<?php
							$query_id = mysqli_query($mysqli, "SELECT Cast(RIGHT(kode_opname,5) as int) as kode 
								FROM is_opname
								ORDER BY kode_opname DESC LIMIT 1")
								or die('Ada kesalahan pada query tampil kode_opname : ' . mysqli_error($mysqli));
							...
							$kode_opname = "OP-".date('Y')."-$buat_id";
							$nama_opname = "";
							$group = "";


							$user = $_SESSION['id_user'];
							$query_user = mysqli_query($mysqli, "SELECT * FROM is_users WHERE id_user = '$user'");
							...
							<div class="form-group">
								<label class="col-sm-2 control-label">Kode Opname</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" name="kode_opname"
										value="<?php echo $kode_opname; ?>" readonly required>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label">Nama Petugas</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" id="nama_petugas" name="kode_user" readonly required
							...
							<div class="form-group">
								...
								<div class="col-sm-5" >
									<input type="text" class="form-control date-picker" data-date-format="dd-mm-yyyy" name="tgl_opname" autocomplete="off" required>
								</div>
							</div>
							...
							<div class="form-group">
								<div class="col-sm-offset-2 col-sm-10">
									...
									<a href="?module=item_opname" class="btn btn-default btn-reset">Batal</a>
								</div>
							</div>
							<hr>
							<div class="form-group">
								...
								<div class="col-sm-5">
									<select class="chosen-select" id="kode_part" name="kode_part"
										data-placeholder="-- Pilih item --" autocomplete="off" onchange="getItemInfo(this)">
										<option value=""></option>
										<?php
							...
							<div class="form-group">
								<label class="col-sm-2 control-label">Stok Komputer</label>
								<div class="col-sm-5">
									<div class="input-group">
										<!--onKeyPress="return goodchars(event,'-0123456789',this)"-->
										<input type="number" class="form-control money" id="qty_komputer" name="qty_komputer" step="0.01"
							...
							<div class="form-group">
								<label class="col-sm-2 control-label">Stok Fisik</label>
								<div class="col-sm-5">
									<div class="input-group">
										<!--onKeyPress="return goodchars(event,'-0123456789',this)"-->
							...
							<table id="table-temp" class="table table-bordered table-striped table-hover table-condensed">
								<thead>
									<tr>
										...
										<th class="center">Stok Komputer</th>
	...
	<?php
		...
		<section class="content-header">
			<h1>
				<i class="fa fa-edit icon-title"></i> Edit Item Opname
			</h1>
			<ol class="breadcrumb">
				<li><a href="?module=beranda"><i class="fa fa-home"></i> Beranda </a></li>
...
<script>
	...
	function getItemInfo(input) {
		...
		$.post("modules/item-opname/invent.php", {
			  item: part[0]
			}, function(response) {      
			$("#qty_komputer").val(parseInt(response));
		});
	}
