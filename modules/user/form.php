          ...
          <form role="form" class="form-horizontal" method="POST" action="modules/user/proses.php?act=insert" enctype="multipart/form-data">
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="number" class="form-control" name="hari_reminder" autocomplete="off" required>
                </div>
              </div>
            </div><!-- /.box body -->
          ...
          <form role="form" class="form-horizontal" method="POST" action="modules/user/proses.php?act=update" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">Reminder</label>
                <div class="col-sm-5">
                  <input type="number" class="form-control" name="hari_reminder" autocomplete="off" value="<?= $data['hari_reminder'] ?>" required>
                </div>
              </div>
            </div><!-- /.box body -->
